...
from bpy.props import FloatVectorProperty, StringProperty, BoolProperty, IntProperty, CollectionProperty, BoolVectorProperty, PointerProperty, FloatProperty
...
class Colors(PropertyGroup):
    color1 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[1.0, 0.0, 0.05])
    color2 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[1.0, 0.5, 0.0])
    color3 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.7, 1.0, 0.0])
    color4 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 1.0, 0.0])
    color5 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 1.0, 0.7])
    color6 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[1.0, 0.0, 0.0])
    color7 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[1.0, 0.0, 1.0])
    color8 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.5, 0.5, 0.0])
    color9 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 0.5, 0.0])
    color10 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 0.5, 0.5])
    color11 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[1.0, 1.0, 0.5])
    color12 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.5, 1.0, 0.5])
    color13 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.5, 0.5, 1.0])
    color14 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[1.0, 0.5, 1.0])
    color15 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[1.0, 0.5, 0.5])
    color16 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 0.0, 0.0])
    color17 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 0.0, 0.0])
    color18 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 0.0, 0.0])
    color19 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 0.0, 0.0])
    color20 = FloatVectorProperty(subtype='COLOR', min=0, max=1, default=[0.0, 0.0, 0.0])
...
class SCENE_PT_namedlayer_layers(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layerCol=["color1","color2","color3","color4","color5","color6","color7","color8","color9","color10","color11","color12","color13","color14","color15","color16","color17","color18","color19","color20"]
        ...
        for layer_idx in range(NUM_LAYERS):
            ...
            if use_extra:
                ...
                op = row.prop(wm.color, layerCol[layer_idx], text="")
                #op.layer_idx = layer_idx
...
def register():
    ...
    bpy.types.WindowManager.color = PointerProperty(type=Colors)
...
def unregister():
    ...
    del bpy.types.WindowManager.color
